...
"[project]/app/api/papers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const papers = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].paper.findMany({
            where: workspaceId ? {
                workspaceId
            } : undefined,
            orderBy: {
...
async function DELETE(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].paper.delete({
            where: {
                id: id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__32eba89a._.js.map